...
public class VanillaDb {
	...
	public static void init(String dirName, BufferMgrType bufferType) {
		...
		// read classes
		queryPlannerCls = PropertiesFetcher.getPropertyAsClass(
				VanillaDb.class.getName() + ".QUERYPLANNER",
				HeuristicQueryPlanner.class, QueryPlanner.class);
		updatePlannerCls = PropertiesFetcher.getPropertyAsClass(
		...
		boolean doCheckpointing = PropertiesFetcher.getPropertyAsBoolean(
	...
	public static void initSPFactory() {
		Class<?> spFactoryCls = PropertiesFetcher.getPropertyAsClass(
	...
	public static void stopProfilerAndReport() {
		...
		try {
			...
			String path = PropertiesFetcher.getPropertyAsString(
