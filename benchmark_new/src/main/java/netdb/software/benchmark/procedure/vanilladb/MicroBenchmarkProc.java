...
import org.vanilladb.core.sql.RecordKey;
import org.vanilladb.core.sql.storedprocedure.StoredProcedure;
import org.vanilladb.core.storage.tx.Transaction;
import org.vanilladb.core.storage.tx.concurrency.conservative.ConservativeOrderedCcMgr;
...
public class MicroBenchmarkProc implements StoredProcedure {
	...
	private static Transaction prepareTransaction(RecordKey[] readKeys, RecordKey[] writeKeys) {
		...
		synchronized (globalLock) {
			tx = VanillaDb.txMgr().transaction(
	...
	private RecordKey[] getWriteKeys() {
